...
class PagoController extends Controller
{
    ...
    public function listPagos($id){
       $pagos=DB::table('pagos')
                    ...
                    ->select('pagos.id','pagos.code','proveedors.nombre_proveedor','tipo_documentos.documento','pagos.nroBoleta','almacenes.nombre','pagos.tipoPago','pagos.subtotal','pagos.igv','pagos.exonerados','pagos.gravados','pagos.otro','pagos.created_at')
